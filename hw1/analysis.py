...
def main():
	json_stream = requests.get("https://api.census.gov/data/2015/acs/acs5/subject?get=NAME,S0101_C01_001E,S0102_C01_005E&for=zip%20code%20tabulation%20area:60615", allow_redirects=True)
