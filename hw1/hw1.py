...
def main():
	...
	graffiti = pd.read_csv("~/ml-ppol/hw1/graffiti.csv",dtype=object)
	...
	buildings = pd.read_csv("~/ml-ppol/hw1/buildings.csv",dtype = object)
	...
	alleys = pd.read_csv("~/ml-ppol/hw1/alleys.csv", dtype = object)
